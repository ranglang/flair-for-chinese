...
class NLPTaskDataFetcher:
    ...
    def fetch_data(task: NLPTask) -> TaggedCorpus:
        ...
        if task == NLPTask.ZH:
            ...
            return NLPTaskDataFetcher.fetch_column_corpus(data_folder,
                                                          ...
                                                          dev_file='dev2.txt',
                                                          tag_to_biloes='ner')
        if task == NLPTask.WEIBO:
            columns = {0: 'text',1: 'ner'}

            return NLPTaskDataFetcher.fetch_column_corpus(data_folder,
                                                          columns,
                                                          train_file='weibo-train.txt',
                                                          test_file='weibo-test.txt',
                                                          dev_file='weibo-dev.txt',
                                                          tag_to_biloes='ner')
    ...
    def read_column_data(path_to_column_file: str,
        ...
        lines: List[str] = codecs.open(path_to_column_file,encoding="utf-8").read().strip().split('\n')
